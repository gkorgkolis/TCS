...
# Experiment with more or less configuration options per phase. Inference time will vary.
"""
...
cd_config = { 
    ...
    #    "cd_method": "CP",
    #    "cd_kwargs": {
    #        "model": "E:/CausalPretraining/Weights/2025+/deep_CI_RH_12_3_merged_290k.ckpt",
