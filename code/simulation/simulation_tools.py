...
def get_optimal_sim(
    ...
    CONFIGS (dict) : a dictionary containing the search spaces for the optimal simulation configuration (default = None)
    ...
    sparsity_k (int) : the number of top configurations checked by the sparsity penalty (default = 5)
    ...
    Return
    ------
    res (dict) : a dictionary with the following fields:
        - optimal_data (pandas.DataFrame) - the simulated data generated by the optimal configuration
